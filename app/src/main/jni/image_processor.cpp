...
static void ensureJniRegistered(JNIEnv *env) {
  ...
  jclass targetsInfoClass =
      env->FindClass("org/team686/droidvision2017/NativePart$TargetsInfo");
  sNumTargetsField = env->GetFieldID(targetsInfoClass, "numTargets", "I");
  sTargetsField = env->GetFieldID(
      targetsInfoClass, "targets",
      "[Lorg/team686/droidvision2017/NativePart$TargetsInfo$Target;");
  jclass targetClass =
      env->FindClass("org/team686/droidvision2017/NativePart$TargetsInfo$Target");
