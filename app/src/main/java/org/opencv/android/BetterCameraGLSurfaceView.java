...
public class BetterCameraGLSurfaceView extends GLSurfaceView {
    ...
    double mHorizFieldOfViewRad;
    double mVertFieldOfViewRad;
    ...
    public void setHorizFieldOfViewRad(double val) {mHorizFieldOfViewRad = val;}
    public void setVertFieldOfViewRad(double val) {mVertFieldOfViewRad = val;}

    public double getFocalLengthPixels()  { return mFocalLengthPixels; }
    public double getHorizFieldOfViewRad(){ return mHorizFieldOfViewRad; }
    public double getVertFieldOfViewRad() { return mVertFieldOfViewRad; }
